...
def init_arg_parser():
    ...
    parser.add_argument("--bart_path", default='/home/ml/cadencao/Downloads/BART_models/bart.large.xsum', type=str,
                        help="Path to BART model.")
    parser.add_argument("--checkpoint_file", default='model.pt', type=str,
                        help="Model name.")
    parser.add_argument("--data_name_or_path", default='/home/ml/cadencao/Downloads/BART_models/bart.large.xsum', type=str,
                        help="BART data_name_or_path.")
    parser.add_argument('--save-dir', metavar='DIR', default='checkpoints',
                        help='path to save checkpoints')

    parser.add_argument('--train_source', metavar='DIR', default='/home/ml/cadencao/XSum/fairseq_files/train.bpe.source',
                        help='path to training document.')
    parser.add_argument('--train_target', metavar='DIR', default='/home/ml/cadencao/XSum/fairseq_files/train.bpe.target',
                        help='path to training summary.')
    parser.add_argument('--dev_source', metavar='DIR', default='/home/ml/cadencao/XSum/fairseq_files/val.bpe.source',
                        help='path to devlopment document.')
    parser.add_argument('--dev_target', metavar='DIR', default='/home/ml/cadencao/XSum/fairseq_files/val.bpe.target',
    ...
    parser.add_argument("--update-freq", default=3, type=int, help="How often to do gradient update.")
