...
def init_arg_parser():
    ...
    parser.add_argument("--bart_path", default='bart.large.xsum', type=str,
                        help="Path to BART model.")
    parser.add_argument("--checkpoint_file", default='model.pt', type=str,
                        help="Model name.")
    parser.add_argument("--data_name_or_path", default='bart.large.xsum', type=str,
    ...
    parser.add_argument("--max_update", default=2e4, type=int,
